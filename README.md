...
```
~/Android/Sdk/emulator/emulator -avd Medium_Phone -camera-back videofile:/path/to/example_video.mp4
```
...
| Model                     |   TP |   FP |   FN |   Precision |   Recall |   F1-Score |   Latency (ms) |   Ref Latency (ms) |   Speed (FPS) |
|:--------------------------|-----:|-----:|-----:|------------:|---------:|-----------:|---------------:|-------------------:|--------------:|
| efficientdet-lite0.tflite |  170 |    8 |  438 |      0.9551 |   0.2796 |     0.4326 |          36.14 |              89.04 |         27.67 |
| yolo26n.onnx              |  251 |   13 |  357 |      0.9508 |   0.4128 |     0.5757 |          42.49 |              90.46 |         23.53 |
| yolo26n.pt                |  257 |    4 |  351 |      0.9847 |   0.4227 |     0.5915 |          13.81 |              90.08 |         72.42 |
| yolo26n_float32.tflite    |  268 |    6 |  340 |      0.9781 |   0.4408 |     0.6077 |          79.05 |              91.44 |         12.65 |
| yolo26x.onnx              |  409 |   24 |  199 |      0.9446 |   0.6727 |     0.7858 |         687.83 |              88.61 |          1.45 |
| yolo26x.pt                |  434 |   17 |  174 |      0.9623 |   0.7138 |     0.8196 |          30.94 |              90.08 |         32.32 |
| yolo26x_float32.tflite    |  438 |   18 |  170 |      0.9605 |   0.7204 |     0.8233 |        2319.84 |              89.5  |          0.43 |
